...
. Jerarquia de clases (superclase -> general y subclase -> particular)
. Útil para reutilizar código (características y comportamiento en común) => compartir conocimiento.
